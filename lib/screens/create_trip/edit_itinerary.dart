...
//   final int trip_id;
//
//   const EditItineraryScreen({super.key, required this.trip_id});
//
//   @override
...
//         final things = List<Map<String, dynamic>>.from(snapshot.data as List);
//         return Column(
//           crossAxisAlignment: CrossAxisAlignment.start,
//           children: [
//             const SizedBox(height: 20),
//             const Text("Things to Carry",
//                 style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
//             const SizedBox(height: 10),
//             ...things.map((item) => ListTile(
